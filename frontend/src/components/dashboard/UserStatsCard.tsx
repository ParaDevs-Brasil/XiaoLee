...
export default function UserStatsCard({ twitterId, isConnected }: UserStatsCardProps) {
  ...
  if (!isConnected) {
    return (
      <div className="bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500 p-[2px] rounded-3xl shadow-xl h-full">
  ...
  return (
    <div className="bg-gradient-to-r from-blue-400 via-indigo-500 to-purple-500 p-[2px] rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300">
        ...
        {loading ? (
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-blue-50 p-4 rounded-2xl text-center">
              <p className="text-sm text-blue-500 font-semibold mb-1">Total Swaps</p>
              <p className="text-3xl font-bold text-blue-700">{userState.swapCount}</p>
            </div>
