...
/* ── Vindos originalmente da landing (src/components/landing/icons.tsx) ── */
...
/* ── Promovidos das páginas do app (Fase 2, docs/FRONTEND_CONSISTENCY_PLAN.md) ──
   Antes duplicados quase identicamente em dashboard/onboarding/traction/TokenomicsCard. */
...
export const IconToken = (p: IconProps) => <Svg {...p}><circle cx="12" cy="12" r="10"/><line x1="12" y1="8" x2="12" y2="16"/><line x1="8" y1="12" x2="16" y2="12"/></Svg>;

/** Bolt/zap — mesmo path do IconBolt, mantido com os dois nomes por compatibilidade semântica. */
